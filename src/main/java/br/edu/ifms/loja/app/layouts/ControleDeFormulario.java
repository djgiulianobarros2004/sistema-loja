...
public class ControleDeFormulario {
     ...
     *
     * @param components Array com os componentes a serem analisados.
     * @param i Índice no array do componente a ser testado.
     * @param estado Indica se o componente vai ser habilitado ou desabilitado.
     * true: para habilitar campos. false: para desabilitar campos.
     */
